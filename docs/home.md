...
5. Promo banner: the Bank's daily coins (a real feature).
...
The painted art (hero, one card per game, the promo banner and the extras) was generated by the owner
with ChatGPT and lives in `src/screens/home/art/`. The images are kept at their original size, converted
to WebP.
